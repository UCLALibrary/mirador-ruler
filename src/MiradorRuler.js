    ...
    template: Mirador.Handlebars.compile([
        '<a href="javascript:;" class="mirador-btn mirador-icon-ruler mirador-tooltip" title="{{t "rulerSettingsTooltip"}}">',
            ...
            '<ul class="dropdown ruler-options-list">',
                ...
                '<li class="ruler-horizontal"><i class="fa fa-text-width fa-lg fa-fw"></i> {{t "rulerOrientationHorizontal"}}</li>',
                '<li class="ruler-vertical"><i class="fa fa-text-height fa-lg fa-fw"></i> {{t "rulerOrientationVertical"}}</li>',
